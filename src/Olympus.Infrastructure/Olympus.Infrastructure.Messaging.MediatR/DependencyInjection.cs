...
public static class DependencyInjection
{
      ...
      Assembly applicationAssembly)
  {
    ...
    services.AddTransient<IOlympusDispatcher, MediatROlympusDispatcher>();
    services.AddTransient<IOlympusEventPublisher, MediatROlympusEventPublisher>();
  ...
  private static void RegisterCommandHandlers(IServiceCollection services, Assembly applicationAssembly)
  {
    ...
    foreach (var handlerType in commandHandlerTypes)
    {
      ...
      services.AddTransient(requestHandlerInterface, sp => sp.GetRequiredService(adapterType));
    }
  }
  ...
  private static void RegisterEventHandlers(IServiceCollection services, Assembly applicationAssembly)
  {
    ...
    foreach (var handlerType in eventHandlerTypes)
    {
      ...
      foreach (var handlerInterface in handlerInterfaces)
      {
        ...
        services.AddTransient(notificationHandlerInterface, sp => sp.GetRequiredService(adapterType));
      }
    }
  }
}
